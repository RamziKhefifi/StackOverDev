...
public class LoginController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        cbrole.getSelectionModel().select("responsable des stages");
    ...
    String sql = "Select * from user where email = ? and password = ? and role=? ";
        try {
            ...
            if((rs.next())&&(s.equals("responsable des stages")) ){ 
                ...
                else   if((rs.next())&&(s.equals("Etudiant")) ) 
                        {
                        
                        }  
                
                 else   if((rs.next())&&(s.equals("Encadrant Académique")) ) 
                        {
                        
                        } 
                  else   if((rs.next())&&(s.equals("Encadrant Professionnel")) ) 
                        {
